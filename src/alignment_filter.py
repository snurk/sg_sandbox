...
parser.add_argument("--use-supplementary", action="store_true", help="Consider supplementary alignments")
parser.add_argument("--use-all", action="store_true", help="Consider all alignments (by default secondary and supplementary are ignored)")
parser.add_argument("--filtered", help="Optional SAM/BAM file for filtered output")
parser.add_argument("--targets", help="Comma separated list of alignment targets to keep (e.g. 'chrX,chrY')")
parser.add_argument("--bed", help="Output bed file specifying covered regions")
parser.add_argument("--bed-trim", type=int, default=0, help="Trim this many bp from the sides of the covered region")
